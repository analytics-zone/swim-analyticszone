...
function calculateStss(cssPaceSeconds,durationMinutes,avgPaceSeconds){const intensityFactor=cssPaceSeconds/avgPaceSeconds;const durationHours=durationMinutes/60;const stss=durationHours*Math.pow(intensityFactor,3)*100;return{stss:Math.round(stss),intensityFactor:intensityFactor.toFixed(3)};}
